...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{asset("front_end/img/logo/CCM02.png")}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Clean Credit Repair</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="https://image.freepik.com/free-vector/businessman-character-avatar-icon-vector-illustration-design_24877-18271.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
          <a href="{{route("customer-inquery")}}" class="nav-link">
          ...
          <a href="{{route("logout")}}" class="nav-link">
            <i class="nav-icon fas fa-cog" style="color: red"></i>
              <p>
                Log out
                {{-- <span class="right badge badge-danger">New</span> --}}
              </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="#">Clean Credit Repair</a>.</strong>
    All rights reserved.
